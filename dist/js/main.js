...
"use strict";
/* harmony import */ var core_js_modules_es_string_split_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3123);
...
(function () {
  ...
  qg_forgov.fn.sampleFunction = function () {}; // Make squiz variable available to the console for debugging


  window.qg_forgov = qg_forgov; //Header Scripts
  ...
  qg_forgov.fn.initAgencyPersonalisation = function () {
    ...
    if (document.cookie) {
      if (qg_forgov.fn.getCookie("agency")) {
        ...
        if (exists) {
          var selects = document.querySelectorAll('.ssq-agencies'),
              i;
  ...
  qg_forgov.fn.initAgencyPersonalisation(); //Handle the video transcripts - taken from forgov
...
"use strict";
/* harmony import */ var core_js_modules_web_url_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(285);
...
/* harmony import */ var core_js_modules_es_string_search_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(4765);
...
/* harmony import */ var core_js_modules_es_array_index_of_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(2772);
...
/* harmony import */ var core_js_modules_es_array_index_of_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(2772);
/* harmony import */ var core_js_modules_es_array_index_of_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_array_index_of_js__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var core_js_modules_es_array_find_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(9826);
/* harmony import */ var core_js_modules_es_array_find_js__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_array_find_js__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var core_js_modules_es_string_trim_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(3210);
...
(function () {
  ...
  $(document).ready(function () {
    ...
    function lightboxToModal(link) {
      ...
      link.attr('data-target', '#forgov-modal');
    ...
    $('#forgov-modal').on('show.bs.modal', function (event) {
      var button = $(event.relatedTarget);
      var modal = $(this);
      var url = button.data('href');
      var title;
      var close = '<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>'; // Get modal title for in-page modal
      ...
      function modalTitle(content) {
        ...
        if (title = modal.find('.modal-body > h2:first-child').eq(0)) {
          ...
          modal.find('.modal-body').before('<div class="modal-header"><h2 class="modal-title mt-0" id="forgov-modal--title">' + titleText + '</h2>' + close + '</div>');
        }
      }
        ...
        success: function success(data) {
          ...
          if (button.data('modalHeader').length) {
            if (modal.find('.modal-title').length) {
              ...
              modal.find('.modal-body').before('<div class="modal-header"><h2 class="modal-title mt-0" id="forgov-modal--title">' + button.data('modalHeader') + '</h2><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button></div>');
            }
          }
        },
        // If the ajax request fails just redirect to the original href.
        error: function error(request, text, _error) {
          modal.find('.modal-content').html('<div class="modal-header"><h2 class="mt-0">Content not available</h2><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button></div>');
        },
...
"use strict";
/* harmony import */ var core_js_modules_es_array_find_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(9826);
...
0,[[5579,666],[1816,666],[1421,666],[7970,666],[5362,666],[7862,666],[5547,666],[8562,666],[8177,666],[5143,666],[3455,666],[9668,666]]]);
