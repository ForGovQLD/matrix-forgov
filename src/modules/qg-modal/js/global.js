(function(){
    ...
    $(document).ready(function() {
        ...
        $('#forgov-modal').on('show.bs.modal', function (event) {
            ...
            // Get modal title for in-page modal
            ...
            $.ajax({
                ...
                success: function (data) {
                    modal.find('.modal-content').html('<div class="modal-body">' + data + '</div>');
        
                    // If the url targets a specific element, replace modal content with only that element
                    if (url.search('#') > 0) {
